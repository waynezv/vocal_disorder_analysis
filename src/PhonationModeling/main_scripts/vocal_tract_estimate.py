...
logger.info(
    "Initial parameters: alpha = {:.4f}   beta = {:.4f}   "
...
while R > 0.1:
    ...
    logger.debug(
        "stiffness K = {:.4f} dyne/cm^3    subglottal Ps = {:.4f} "
        "dyne/cm^2    time_scaling = {:.4f}".format(K, Ps, time_scaling)
    )
    ...
    logger.info(
        "L2 Residual = {:.4f} | alpha = {:.4f}   beta = {:.4f}   "
